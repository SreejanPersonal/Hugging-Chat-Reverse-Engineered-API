...
class HuggingChat_RE:
    def __init__(self, hf_chat: str, model: str = "meta-llama/Meta-Llama-3-70B-Instruct", system_prompt: str = "Be helpful and friendly") -> None:
        """
    ...
    def find_conversation_id(self) -> str:
        ...
        response = self.session.post(url, json=payload, headers=self.headers).json()
